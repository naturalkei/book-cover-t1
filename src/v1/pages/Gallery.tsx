...
import BookCard from '@v1/components/gallery/BookCard'
import { Books as defaultBooks, type IBook } from '@v1/data/books'
import { GalleryEmptyState } from '@v1/lib/class-names'
      ...
      {books.length === 0
        ? (
          <div role="status" className={GalleryEmptyState}>
            ...
            <p className="mt-2 text-sm">Add a book to <code className="font-mono">src/v1/data/books.ts</code> to populate the gallery.</p>
          </div>
        )
        : (
          <ul
