...
import CoverModeToggle from '@v1/components/reader/CoverModeToggle'
import FlipPresetPicker from '@v1/components/reader/FlipPresetPicker'
import NotFound from '@v1/components/NotFound'
import PageFlip from '@v1/components/reader/PageFlip'
import PageJumpInput from '@v1/components/reader/PageJumpInput'
import ReaderControls from '@v1/components/reader/ReaderControls'
import RoundedToggle from '@v1/components/reader/RoundedToggle'
import ThumbnailScrubber from '@v1/components/reader/ThumbnailScrubber'
import ViewModeToggle from '@v1/components/reader/ViewModeToggle'
import { TextLink } from '@v1/lib/class-names'
import { getBookById } from '@v1/data/books'
import { useCoverMode, type TCoverMode } from '@v1/hooks/cover-mode'
import { useFlipPreset } from '@v1/hooks/flip-preset'
import { useReaderKeyboard } from '@v1/hooks/reader-keyboard'
import { useRoundedCorners } from '@v1/hooks/rounded-corners'
import {
  getEffectiveStep,
...
export default function Reader() {
  ...
  const exitToGallery = useCallback(() => navigate('/v1'), [navigate])
