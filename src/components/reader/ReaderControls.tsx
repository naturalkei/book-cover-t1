...
export default function ReaderControls({ pageIndex, totalPages, onPageChange, step = 1 }: ReaderControlsProps) {
  const canPrev = pageIndex >= step
  const canNext = pageIndex + step < totalPages
  const showsRange = step > 1 && pageIndex + 1 < totalPages
