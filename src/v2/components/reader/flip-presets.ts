...
const buildPaperClassicTransform = (
...
const classicShadow = (mode: TViewMode, phase: 'rest' | 'lifted') => {
  ...
  return phase === 'rest'
    ? '0 12px 28px -14px rgba(0, 0, 0, 0.32)'
    : '0 36px 68px -18px rgba(0, 0, 0, 0.52)'
}
...
const FlipPresets: IFlipPreset[] = [
  {
    id: 'classic',
    label: 'Classic',
    description: 'Paper-like 3D page turn with spine pivot and lift.',
